...
copyright = f'2018-{current_time.strftime("%Y")}, KuDikan. Last updated: {current_time.strftime("%Y-%m-%d %H:%M:%S")}'
author = 'KuDikan'
...
latex_documents = [
    ('pdf_index', 'kjo-rule.tex', 'kjo-rule Documentation',
     'KuDikan', 'manual'),
]
...
man_pages = [
    (master_doc, 'kjo-rule', 'kjo-rule Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kjo-rule', 'kjo-rule Documentation',
     author, 'kjo-rule', 'One line description of project.',
     'Miscellaneous'),
]
